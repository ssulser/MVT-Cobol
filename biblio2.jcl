...
//COB.SYSIN DD *
      ...
      *
       ...
       MAINLINE-CONTROL-ROUTINE.
           ...
           PERFORM PROCESS-PRINT-READ THRU PROCESS-PRINT-READ-EXIT
      ...
      *
       INITIALIZATION.
           OPEN INPUT  INPUT-FILE,
                OUTPUT PRINT-FILE.
           WRITE PRINT-LINE FROM REPORT-TITLE BEFORE 2 LINES.
           WRITE PRINT-LINE FROM COLUMN-HEADER BEFORE 2 LINES.
      ...
      *
       PROCESS-PRINT-READ.
           MOVE BOOK-TITLE OF INPUT-RECORD TO
                BOOK-TITLE OF BIBLIOGRAPHY-DETAIL-LINE.
           MOVE BOOK-AUTHOR-NAME OF INPUT-RECORD  TO
                BOOK-AUTHOR-NAME OF BIBLIOGRAPHY-DETAIL-LINE.
           MOVE BOOK-PUBLISHER OF INPUT-RECORD TO
                BOOK-PUBLISHER OF BIBLIOGRAPHY-DETAIL-LINE.
           MOVE BOOK-PRICE OF INPUT-RECORD TO
                BOOK-PRICE OF BIBLIOGRAPHY-DETAIL-LINE.
           WRITE PRINT-LINE FROM BIBLIOGRAPHY-DETAIL-LINE
               AFTER 1 LINES.
           ADD BOOK-PRICE OF INPUT-RECORD TO SUM-OF-BOOK-PRICES.
           READ INPUT-FILE AT END MOVE 'NO' TO MORE-CARDS.
       PROCESS-PRINT-READ-EXIT.
           EXIT.
      *
